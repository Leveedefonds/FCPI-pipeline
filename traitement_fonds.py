...
st.set_page_config(
    page_title="Reporting AUDACIA CAPITAL INNOVATION",
    page_icon="🚀",
    layout="wide",
...
# ─── SIDEBAR ────────────────────────────────────────────────────────────────────
with st.sidebar:
    st.markdown('<div style="font-family:JetBrains Mono,monospace;font-size:1rem;font-weight:700;color:#39ff14;letter-spacing:2px;padding:0.5rem 0 0.2rem">⚛ AUDACIA CAPITAL INNOVATION</div><div style="font-size:0.65rem;color:#4a8a4a;letter-spacing:1.5px;margin-bottom:0.5rem;font-family:JetBrains Mono,monospace"> FCPI</div>', unsafe_allow_html=True)
    st.markdown("---")
...
<div class="main-header">
    <div class="header-badge">🚀 FCPI </div>
    <h1>AUDACIA CAPITAL INNOVATION — <span>Pipeline Dashboard</span></h1>
...
body { font-family: 'Space Grotesk', sans-serif; font-size: 0.79rem; background: white; }
    ...
    st.download_button(
        ...
        data=output,
        file_name=f"pipeline_fcpi_{today.strftime('%Y%m%d')}.xlsx",
